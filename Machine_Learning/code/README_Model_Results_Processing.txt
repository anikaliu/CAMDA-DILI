...
(2) 
Input files for scripts can be found in CAMDA-DILI/Machine_Learning/data/
...
(4)
Scripts: summarize_performance.R

Purpose: Generate Figures 1, S1, and S2 of manuscript
