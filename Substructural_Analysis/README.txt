...
(2)
File order - base file is "standardized_compounds_incl_ambiguous.csv" (in CAMDA-DILI/processed_data/Standardization). Additionally the file "DrugBank_5_1_4_approved.csv" (in CAMDA-DILI/Data_Processing/DrugBank) is required for step (D)
