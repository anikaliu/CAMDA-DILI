...
for i in range(X.shape[0]):
    ...
    pr_label.append(clf.predict(X[i,:].reshape(1,-1)))
    correct.append((true_label[i]==pr_label[i])*1)
    probability.append(clf.predict_proba(X[i,:].reshape(1,-1)))
