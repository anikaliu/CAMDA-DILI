...
def rf_param_selection(X, y, cvsplit):
    ...
    grid_search = GridSearchCV(clf, param_grid, cv=cvsplit, scoring='balanced_accuracy', n_jobs=30)
    grid_search.fit(X, y)
...
files2 = ["External_('A375', 6, 10).csv", "External_('A549', 24, 10).csv", "External_All_Cell_Lines.csv", "External_('ASC', 24, 10).csv", "External_('HA1E', 6, 10).csv",
         "External_('HCC515', 6, 10).csv", "External_('HEPG2', 6, 10).csv", "External_('HT29', 6, 10).csv", "External_('MCF7', 6, 10).csv", "External_('PC3', 6, 10).csv",
