...
zf = zipfile.ZipFile('../data/data_paper/MD_red/Predictions_MD_red.zip', mode='w')
for i,j in zip(predictions,predictions_ident):
    name = j.replace('.','_')
    i.to_csv(path_or_buf='../data/data_paper/MD_red/Predictions_MD_red/'+name+'.txt',sep=',',index=False)
    zf.write('../data/data_paper/MD_red/Predictions_MD_red/'+name+'.txt')
    os.remove('../data/data_paper/MD_red/Predictions_MD_red/'+name+'.txt')
zf.close()
...
df_ts.to_csv('../data/data_paper/MD_red/ts_scores_MD_red_yscr.csv',sep=',',index=False)
...
df_cv.to_csv('../data/data_paper/MD_red/cv_scores_MD_red_yscr.csv',sep=',',index=False)

#export best params
output = open('../data/data_paper/MD_red/best_params_MD_red_yscr.pkl','wb')
